...
var siteConfig = {
  ...
  highlightedFilters: ['q', 'taxonKey', 'catalogNumber', 'locality', 'waterBody', 'year', 'countryCode', 'basisOfRecord'], // or whatever you believe is the most useful filters for your audience
};
